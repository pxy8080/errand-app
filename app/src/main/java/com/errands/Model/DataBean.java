...
//    }
    ...
    public static List<DataBean> getTestData3() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.drawable.logo, "", 1));
        list.add(new DataBean(R.drawable.ic_launcher_background, "null", 1));
        list.add(new DataBean(R.drawable.abc_vector_test, "null", 1));
        list.add(new DataBean(R.drawable.ic_user, "null", 1));
        list.add(new DataBean(R.drawable.bg, "null", 1));
        return list;
    }
